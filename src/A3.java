public class A3 { //외부 클래스 A3
	...
	class B{//인스턴스 멤버 내부클래스
		void method01() {
			/* 인스턴스 멤버 내부클래스 메서드 내에서 외부클래스의 인스턴스 변수,인스턴스 메서드,정적변수,정적메서드에
			 * 접근할 수 있다.
			 */
			field01=10;
			method01();
	...
	static class C{//정적 멤버 내부 클래스
		void method02() {
			...
			field02=20; //정적 멤버 내부 클래스에서 외부클래스의 정적변수와 정적메서드 접근 가능.
			method02();
		}
	}//C class
}
